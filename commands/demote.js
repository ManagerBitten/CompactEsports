...
module.exports = {
    ...
    .addUserOption(option => 
        option
        .setName('user')
        .setDescription('Staff member you want to demote')
        .setRequired(true))
    ...
    async execute (interaction) {
        try {
            ...
            .setDescription(`Compact Esports has been scrutinizing your efforts and have been keeping an eye on you for the past few months and is alarmed to inform you that your activity and effort has been below the standards we expect from an **${role2.name}**.\n\nYou have been placed in the position of **${role1.name}** for now and your efforts will be observed accordingly. Depending on your performance from here on out we will consider your former position again and decide if you deserve to move higher. We expect this to not demotivate you but rather encourage you to work harder and prove your worth once again.\n\nHope to see you continue working with us.\n\nBest Regards`)
            .setColor(0xff0000)
            const embed2 = new EmbedBuilder()
            .setDescription(`**${user.user.username}** has been demoted.`)
            .setColor(0xff0000) 
